...
from alert_engine import AlertEngine   # <-- Fixed import
...
class StockScanner:
    ...
    def process_symbol(self, symbol, data):
        ...
        # Strategy (replaces signal_engine)
    ...
    def send_alerts(self):
        ...
        for _, row in self.results.iterrows():
            ...
            # Use the existing process() method of AlertEngine
    ...
    def save_logs(self):
        ...
        for _, row in self.results.iterrows():
            ...
            self.logger.save_trade(
                ...
                exit_price=0,
                sl=row["SL"],
                target=row["Target1"],        # Fixed: use Target1 column
                qty=row["Qty"],
                pnl=0,
                pnl_percent=0,
...
if __name__ == "__main__":
    ...
    st.title("AI Stock Scanner V1.3")
